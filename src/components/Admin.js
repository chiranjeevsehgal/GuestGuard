            ...
            <header className="p-4 bg-gray-100 text-gray-800">
                <div className="container flex justify-between h-16 mx-auto">
                    ...
                    <ul className="items-stretch hidden space-x-3 lg:flex">
                        <li className="flex">
                            <a rel="noopener noreferrer" href="/admin" className="flex items-center px-4 -mb-1 border-b-2 border-transparent text-cyan-600 border-cyan-600">Admin Panel</a>
                        </li>
                        <li className="flex">
                            <a rel="noopener noreferrer" href="" className="flex items-center px-4 -mb-1 border-b-2 border-transparent">Profile</a>
                        </li>
                        <li className="flex">
