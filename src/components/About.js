                                    ...
                                    <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
                                        ...
                                        <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 bg-cyan-500 text-gray-100">
                                            ...
                                            <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
                                                <a rel="noopener noreferrer" href="#" title="Email" className="text-gray-50 hover:text-cyan-600">
                                                ...
                                                <a rel="noopener noreferrer" href="#" title="LinkedIn" className="text-gray-50 hover:text-cyan-600">
                                                ...
                                                <a rel="noopener noreferrer" href="#" title="GitHub" className="text-gray-50 hover:text-cyan-600">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5">
