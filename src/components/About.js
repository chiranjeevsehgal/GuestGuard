                                    ...
                                    <div class="flex flex-col lg:flex-row justify-center lg:space-x-8 mt-16 gap-y-4">
                                        ...
                                        <div class="flex flex-col justify-center w-full px-4 my-6 sm:w-96 bg-cyan-500 text-gray-100 rounded-md">
                                            ...
                                            <div className="flex items-center justify-center p-3 space-x-3 border-t-2">
                                                ...
                                                <a rel="noopener noreferrer" href="/about" title="Twitter" className="text-gray-50 hover:text-cyan-600">
                                                ...
                                                <a rel="noopener noreferrer" href="/about" title="LinkedIn" className="text-gray-50 hover:text-cyan-600">
                                                ...
                                                <a rel="noopener noreferrer" href="/about" title="GitHub" className="text-gray-50 hover:text-cyan-600">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5">
