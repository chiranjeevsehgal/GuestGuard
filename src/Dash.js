    ...
    return (
		...
		<div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
			...
			<div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0 sm:space-x-4 lg:justify-start">
				<a rel="noopener noreferrer" href="/signin" className="px-8 py-3 text-lg font-semibold rounded text-gray-50 bg-cyan-600" >Generate Gate Pass</a>
				<a rel="noopener noreferrer" href="/navigation" className="px-8 py-3 text-lg font-semibold border rounded border-gray-800">Navigation</a>
			</div>
		</div>
